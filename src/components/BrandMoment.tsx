...
import { AirVent, BadgeCheck, HandCoins, Timer } from 'lucide-react'
...
const REASONS = [
  { icon: AirVent, title: 'Especialistas em ar-condicionado', text: 'Instalação, higienização, manutenção e reparo com a mesma equipe.' },
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 sm:px-8 lg:grid-cols-2 lg:gap-16">
        ...
        >
          <motion.div
            ...
            className="relative mx-auto aspect-square w-full max-w-[560px] overflow-hidden rounded-[44px] shadow-[0_50px_90px_-40px_rgba(11,58,110,0.55)]"
          >
        ...
        <div className="order-1 lg:order-2">
          ...
          <ul className="mt-10 grid gap-x-8 gap-y-8 sm:grid-cols-2">
            {REASONS.map(({ icon: Icon, title, text }) => (
              <li key={title}>
                <span className="grid size-12 place-items-center rounded-2xl bg-gradient-to-br from-ciano-glow via-ciano to-ciano-600 text-white shadow-[0_14px_30px_-14px_rgba(22,182,238,0.9)]">
