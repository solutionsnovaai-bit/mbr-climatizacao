          ...
          {SERVICES.map((s) => (
            <li key={s.title} className="border-b border-navy/12">
              ...
              >
                ...
                <span className="mt-1 grid size-11 shrink-0 place-items-center rounded-full border border-navy/15 text-navy transition-all duration-500 group-hover:border-transparent group-hover:bg-ciano group-hover:text-white">
