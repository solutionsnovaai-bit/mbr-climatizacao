    ...
    <AnimatePresence>
      {ready && (
        ...
        >
          ...
          >
            <span aria-hidden className="pulse-ring absolute inset-0 rounded-full bg-azul-glow/50" />
            <span
              aria-hidden
              className="absolute inset-0 rounded-full transition-transform duration-500 group-hover:scale-105"
              style={{
                background: 'linear-gradient(145deg, #1e8cf5 0%, #0a6ce0 40%, #01265a 100%)',
                boxShadow:
                  'inset 0 2px 0 rgba(255,255,255,0.45), inset 0 -10px 18px -8px rgba(0,0,0,0.45), 0 18px 36px -12px rgba(10,108,224,0.85), 0 0 0 4px rgba(234,243,250,0.55)',
              }}
            />
            <span aria-hidden className="absolute inset-x-3 top-1.5 h-5 rounded-full bg-gradient-to-b from-white/45 to-white/0" />
            <WhatsAppIcon className="relative size-[30px] drop-shadow-[0_2px_4px_rgba(1,38,90,0.5)]" />
          </a>
        </motion.div>
      )}
    </AnimatePresence>
