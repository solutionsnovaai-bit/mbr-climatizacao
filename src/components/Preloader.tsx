...
export function Preloader({ onFinish, reduced }: { onFinish: () => void; reduced: boolean }) {
  ...
  return (
    <motion.div
      ...
      style={{
        background:
          'radial-gradient(120% 80% at 50% 42%, #f8fbfe 0%, #e3eff9 45%, #c9e1f4 100%)',
      }}
      exit={
        reduced
      ...
      <div className="relative flex flex-col items-center px-6">
        ...
        <div className="relative w-[min(70vw,380px)]" style={{ aspectRatio: '1063 / 943' }}>
          <motion.img
            ...
            draggable={false}
            className="absolute inset-0 h-full w-full select-none drop-shadow-[0_30px_40px_rgba(1,38,90,0.18)]"
        ...
        >
          <div className="wide tabular flex items-start font-extrabold leading-none text-navy">
            ...
            <span className="ml-1 mt-1 text-lg text-azul sm:text-xl">°C</span>
          </div>
