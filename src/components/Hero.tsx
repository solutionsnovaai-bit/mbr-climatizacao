...
import { Building2, MessagesSquare, Sparkles } from 'lucide-react'
...
const TRUST = [
  ...
  { icon: Sparkles, text: 'Instalação e higienização' },
  ...
  return (
    <div className={isDesk ? 'text-left' : 'mx-auto max-w-[34rem] text-center'}>
      ...
      >
        ...
        <span className="semi-wide block pt-[0.08em] text-ciano-ink" style={{ fontStretch: '100%' }}>
      ...
      >
        Instalação, higienização, manutenção e reparo de ar-condicionado. Do split do quarto ao ar da sua empresa, em São Paulo e região.
      </motion.p>
      ...
      >
        {TRUST.map(({ icon: Icon, text }) => (
          <li key={text} className="flex items-center gap-2">
            <span className="grid size-7 place-items-center rounded-full bg-white/70 text-ciano-ink shadow-[0_4px_14px_-6px_rgba(11,58,110,0.35)]">
