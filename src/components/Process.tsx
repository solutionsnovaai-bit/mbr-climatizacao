            ...
            <ol className="grid gap-10 lg:grid-cols-4 lg:gap-8">
              {STEPS.map((s, i) => (
                <li key={s.title} className="relative flex gap-5 lg:block">
                  <span className="wide relative z-10 grid size-[46px] shrink-0 place-items-center rounded-full bg-gradient-to-br from-ciano-glow via-ciano to-ciano-600 text-[1.05rem] font-extrabold text-white shadow-[0_0_0_6px_rgba(241,247,252,1),0_10px_24px_-8px_rgba(22,182,238,0.9)]">
                    {i + 1}
                  </span>
