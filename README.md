...
Landing page da MBR Climatização (instalação, higienização, manutenção e reparo de ar-condicionado, São Paulo e região).
...
- `src/config/site.ts`: telefone, e-mail, endereço, textos de serviços, FAQ, palavras do carrossel e tamanhos da calculadora de BTU.
...
- `public/og-mbr.jpg`: imagem do card (1200x630).
